...
:
{
	echo '<link href="plugins/payplans/payplans/paymill.css" rel="stylesheet">';
}
endif;
		...
		function submitme()
		{
			jQuery('#pp-payment-app-buy').attr("disabled", "disabled");
				...
				if(payment_type == 'cc')
				{
					try {
						paymill.createToken({
							number:     jQuery('#checkout_form .paymill-card-number').val(),
							exp_month:  jQuery('#checkout_form .paymill-card-expiry-month').val(),
							exp_year:   jQuery('#checkout_form .paymill-card-expiry-year').val(),
							cvc:        jQuery('#checkout_form .paymill-card-cvc').val(),
							cardholder: jQuery('#checkout_form .paymill-card-holdername').val(),
							amount: jQuery('#checkout_form .paymill-card-amount').val(),
							currency: jQuery('#checkout_form .paymill-card-currency').val(),
...
<div class="pp-grid_12 pp-payment-authorize-arb">
	<form method="post" action="<?php echo $post_url; ?>" id="checkout_form">
		...
		echo $this->_render('partial_amount', compact('currency', 'amount'),
		'default') . XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_PAYMENT_AMOUNT');
		?>
        </div>
        <div class="pp-row">
          <div class="pp-col pp-label"><?php echo XiText::_('NAME');?></div>
          <div class="pp-col pp-input"><input type="text" name="paymill-card-nm" 
          class="paymill-card-holdername"  type="text" size="20" value="" /></div>
        </div>
         <div class="pp-row">
         ...
         <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text" class="paymill-card-number" name="paymill-card-no"  type="text"  size="16" value="" /></div>
        </div>
        ...
        <div class="pp-row">
          ...
          <div class="pp-col pp-input">
			...
			/*** current month ***/
			$select = '<select name="card-expiry-month" class="paymill-card-expiry-month"  style="width:93px;">' . "\n";
			...
			/*** create the select ***/
			$select = '<select name="card-expiry-year" class="paymill-card-expiry-year"style="width:93px;">';
        ...
        <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text" class="paymill-card-cvc"
          name="paymill-card-ex-cvc" type="text" maxlength="4"  value="" /></div>
        </div>
       </div>
       <div id="bank" style="display:none;">
		 <div class="pp-row">
			  <div class="pp-col pp-label"><?php echo XiText::_('ACCOUNT_NUMBER')?></div>
			  <div class="pp-col pp-input"><input type="text" class="paymill-debit-number" maxlength="10" value="" /></div>
        </div> 
         <div class="pp-row">
			  <div class="pp-col pp-label"><?php echo XiText::_('BANK_CODE_NUMBER')?></div>
			  <div class="pp-col pp-input"><input type="text" class="paymill-debit-bank" maxlength="8" value="" /></div>
        </div> 
		 <div class="pp-row">
			  <div class="pp-col pp-label"><?php echo XiText::_('COUNTRY')?></div>
			  <div class="pp-col pp-input"><input type="text" class="paymill-debit-country" maxlength="20" value="" /></div>
        </div> 
       </div>
      ...
      <fieldset class="pp-parameter pp-small">
        ...
        <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text"
          class="required pp-secondary pp-color pp-border pp-background"
          name="x_first_name" value="" /></div>
        </div>
        <div class="pp-row">
           <div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_LAST_NAME')?></div>
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_last_name" value="" /></div>
        </div>
         <div class="pp-row">
...
<?php
if ($this->getAppParam('customer_id', 0))
:
?>
		<div class="pp-row">
		<div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_CUSTOMER_ID')?></div>
		<div class="pp-col pp-input"><input type="text"
		class="required pp-secondary pp-color pp-border pp-background" name="x_cust_id" value="" /></div>
		</div>
...
?>
         <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_phone" value="" /></div>
        </div>
...
?>
         <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text"
          class="required pp-secondary pp-color pp-border pp-background" name="x_fax" value="" /></div>
        </div>
<?php 
endif;
...
?>
		<div class="pp-row">
           ...
           <div class="pp-col pp-input"><input type="text" 
           class="required pp-secondary pp-color pp-border pp-background" name="x_company" value="" /></div>
        </div>
<?php
endif;
...
?>
        <div class="pp-row">
          ...
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_address" value="" /></div>
        </div>
        <div class="pp-row">
           <div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_CITY')?></div>
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_city" value="" /></div>
        </div>

        <div class="pp-row">
           <div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_STATE')?></div>
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_state" value="" /></div>
        </div>
        <div class="pp-row">
           <div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_ZIP_CODE')?></div>
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_zip" value="" /></div>
        </div>
        <div class="pp-row">
           <div class="pp-col pp-label"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_COUNRTY')?></div>
          <div class="pp-col pp-input"><input type="text" 
          class="required pp-secondary pp-color pp-border pp-background" name="x_country" value="" /></div>
        </div>
      </fieldset>

	 <fieldset class="pp-parameter">
	      <div class="pp-row">
	      	<div class="pp-col pp-label"><button id="pp-payment-app-buy" 
	      	type="button" onclick="submitme();" class ="pp-button ui-button ui-widget ui-button-primary ui-corner-all ui-button-text-only">
	      	<?php echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_BUY')?></button></div>
	  	  	<div class="pp-col pp-input"><a class="pp-button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	  	href="<?php echo XiRoute::_("index.php?option=com_payplans&view=payment&task=complete&action=cancel&payment_key=" . $payment->getKey()); ?>">
		<?php 
			echo XiText::_('COM_PAYPLANS_PAYMENT_APP_AUTHORIZE_CANCEL')?></a></div>
	      </div>
      </fieldset>
      
		<input name="token"  id="token" type="hidden" size="20" value="" />
		<input type="hidden" class="paymill-card-currency"  name="card-currency" size="10" value="<?php echo $currency_code;?>" />
		<input type="hidden" name="payment_key" value="<?php echo $payment->getKey();?>" />
		<input type="hidden" class="paymill-card-amount" name="card-amount" value="<?php echo $amount;?>" />
	</form>
</div>
